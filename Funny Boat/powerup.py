...
class Powerup(pygame.sprite.Sprite):
    def __init__(self):
        ...
        # Inicializa os recursos de Health se necessário
        if not health.Health.heart_full or not health.Health.heart_empty:
            health.init()

        # Usa a imagem de coração cheio como imagem do Powerup
        self.image = health.Health.heart_full
